...
def find_one_rating_review(investor_id)
  return nil unless investor_id #guard condition - early return 
  return run_sql("SELECT * FROM investor_ratings WHERE investor_id = #{investor_id};").first
end
...
def rate_review(investor_id, user_id, rating, review)
  puts 'teststestsetst'
  return run_sql("INSERT INTO investor_ratings (investor_id, user_id, rating, review) VALUES ($1, $2, $3, $4);", [investor_id, user_id, rating, review])
end
